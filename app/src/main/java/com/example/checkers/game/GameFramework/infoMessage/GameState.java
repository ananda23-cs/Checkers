package com.example.checkers.game.GameFramework.infoMessage;

import static com.example.checkers.game.GameFramework.utilities.Saving.SEPARATOR;
...
public abstract class GameState extends GameInfo {
    ...
    public abstract boolean hasEnemyPieces(int xCord, int yCord);
}
